...
int main()
{
    ...
    orquesta_mock(array,&contadorIdorquesta);
            ...
            do{
                ...
                switch(opcion)
                {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        if(!informes_promedioInstrumentos(arrayMusico,QTY_ARRAY_MUSICO,array,QTY_ARRAY_ORQUESTA,&promedioInstrumentos))
                        {
